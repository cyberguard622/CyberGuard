document.addEventListener('DOMContentLoaded', () => {
  ...
  // State Management (Theme & Language Preference)
  ...
  if (langToggle) {
    langToggle.addEventListener('click', () => {
      ...
      filterAdvisories(); // Refresh filters to reflect correct dynamic counts
    });
  }
  ...
  // Dynamic Advisory Search and Filter Parameters
  ...
  // Interactive Scenario Evaluation Quiz
  ...
  // Incident Form Transmission (Direct Endpoint REST Dispatch)
